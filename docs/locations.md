...
Coordinates are WGS84 (latitude, longitude) from OpenStreetMap, September 2026.
...
| Tartu lennujaam | 58.30868 | 26.68411 | 6 km south of centre |
...
The Maa-amet ETAK layer `E_601_elektriliin_j` has the same lines with tower positions in `E_602_tehnopaigaldis_p`.
